...
void lv_draw_vector(lv_vector_dsc_t * dsc, const lv_area_t * origin_coords)
{
    if(!dsc->tasks.task_list) {
        return;
    }
    ...
    // have object/widget coordinates.... 
    lv_draw_task_t * t = lv_draw_add_task(layer, origin_coords, LV_DRAW_TASK_TYPE_VECTOR);
